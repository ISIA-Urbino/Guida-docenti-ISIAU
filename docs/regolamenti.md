...
- [Regolamento di funzionamento della Consulta degli Studenti](assets/regolamenti/1724920779618_regolamento_di_funzionamento_della_consulta_degli_studenti_-_i.s.i.a._urbino.pdf){:target="_blank"}
- [Regolamento didattico generale](assets/regolamenti/1733414944559_regolamento_didattico_-_isia_di_urbino_-_prot.n._3898.pdf){:target="_blank"}
- [Regolamento tesi](<assets/regolamenti/Regolamento tesi-1.pdf>){:target="_blank"}

## Regolamento Codice Etico
- [Estratto D.lgs. 165/2001](<assets/regolamenti/regolamento-codice-etico/0 - Estratto D.Lgs. 165 del 2001.pdf>){:target="_blank"}
- [Regolamento recante codice di comportamento dei dipendenti pubblici](<assets/regolamenti/regolamento-codice-etico/1 - ISIAU_Nuovo Codice Comportamento dei dipendenti pubblici.pdf>){:target="_blank"}
- [Norme disciplinari del personale docente](<assets/regolamenti/regolamento-codice-etico/2 - ISIAU_Norme disciplinari personale docente.pdf>){:target="_blank"}
- [Norme disciplinari del personale non docente](<assets/regolamenti/regolamento-codice-etico/3- ISIAU_Norme disciplinari personale non docente.pdf>){:target="_blank"}
